...
import pandas as pd
import requests
import streamlit as import base64
import datetime
import glob
import json
import os
...
try:
  html_content = f"""
    ...
    /* Κινούμενο μήνυμα προτροπής οριζόντιας θέασης */
    .rotate-hint {{
        display: none;
    ...
    .rotate-icon {{
        ...
        animation: rotate-phone-anim 3s infinite ease-in-out;
    }}
